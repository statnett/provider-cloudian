...
func SetupGated(mgr ctrl.Manager, o controller.Options) error {
	...
	}, userv1alpha1cluster.UserGroupVersionKind)
	return nil
}
...
func Setup(mgr ctrl.Manager, o controller.Options) error {
	...
	r := managed.NewReconciler(mgr,
		resource.ManagedKind(userv1alpha1cluster.UserGroupVersionKind),
		reconcilerOpts...)

	if err := mgr.Add(statemetrics.NewMRStateRecorder(
		mgr.GetClient(), o.Logger, o.MetricOptions.MRStateMetrics, &userv1alpha1cluster.UserList{}, o.MetricOptions.PollStateMetricInterval)); err != nil {
		return err
	}
...
func (c *connector) Connect(ctx context.Context, mg resource.Managed) (managed.ExternalClient, error) {
	cr, ok := mg.(*userv1alpha1cluster.User)
	if !ok {
