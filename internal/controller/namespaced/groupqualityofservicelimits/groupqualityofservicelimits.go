...
func SetupGated(mgr ctrl.Manager, o controller.Options) error {
	...
	}, userv1alpha1namespaced.GroupQualityOfServiceLimitsGroupVersionKind)
	return nil
}
...
func Setup(mgr ctrl.Manager, o controller.Options) error {
	...
	if err := mgr.Add(statemetrics.NewMRStateRecorder(
		mgr.GetClient(), o.Logger, o.MetricOptions.MRStateMetrics, &userv1alpha1namespaced.GroupQualityOfServiceLimitsList{}, o.MetricOptions.PollStateMetricInterval)); err != nil {
		return err
	}
